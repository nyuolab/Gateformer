...
We provide the PyTorch implementation of **Gateformer**, a Transformer-based model for multivariate time series forecasting that integrates temporal (**cross-time**) and variate-wise (**cross-variate**) attention with **gated representations**.
